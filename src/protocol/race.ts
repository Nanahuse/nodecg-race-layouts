...
export type RaceLoadFailureReason = "invalid_url" | "race_not_found" | "race_load_failed" | "draft_build_failed";
...
export type RaceReconcileResponse =
  | { ok: true; changed: boolean; draftRevision: number; participantCount: number; unresolvedPlayerCount: number }
