...
| ---- | ----------------------- | ------------------------ | ---------------------------- | ------------------------------- |
| P1   | 0, 0, 716×540           | 716, 150, 244×390        | 730, 171, 216×72             | 733, 174, 210×66                |
| P2   | 1204, 0, 716×540        | 960, 150, 244×390        | 974, 171, 216×72             | 977, 174, 210×66                |
| P3   | 0, 540, 716×540         | 716, 540, 244×350        | 730, 561, 216×72             | 733, 564, 210×66                |
| P4   | 1204, 540, 716×540      | 960, 540, 244×350        | 974, 561, 216×72             | 977, 564, 210×66                |

中央カラムの内訳は、Event Header 150px（Event branding 96px、Commentary 54px）、P1/P2 Player Cards 390px、P3/P4 Player Cards 350px、Category/World Record 190pxです。Event logoがない、または読み込みに失敗した場合はEvent名（あればshort name）を表示します。CommentatorsはHeader内に最大3人表示します。最下部ではCategory、WORLD RECORDラベル、記録タイム、holderを縦に並べます。Timer frameは3px borderのみで内側が透明です。Slot未割当時はそのVideo border/tagとCard内のTimer・Player情報を隠しますが、中央のCard領域や他Slotは移動しません。
