...
`race.html`は1920×1080固定レイアウトです。P1 / P2を上段、P3 / P4を下段に配置し、各映像枠は**848×477px（16:9）**です。外周余白は左右88px・上下24pxで、中央の間隔は48px、上下段の間には高さ78pxのCategory / WR / Commentary帯があります。空SlotはRace Graphic全体から取り除かれますが、他Slotの配置は変わりません。
